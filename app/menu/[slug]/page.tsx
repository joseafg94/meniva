...
export default async function MenuPage({ params }: PageProps) {
  ...
  const { data: restaurant } = await supabase
    .from('restaurants')
    .select('id, name, description, logo_url, cover_url, banner_active, banner_text, banner_color, banner_emoji, banner_expires_at, primary_color, secondary_color, menu_font, whatsapp_number, whatsapp_button_type, whatsapp_message')
    .eq('slug', slug)
    .single()
