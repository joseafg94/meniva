  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-zinc-900 items-center justify-center p-12 relative overflow-hidden">
        {/* Fondo con degradado y sutil textura */}
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <h2 className="text-4xl font-extrabold text-white leading-tight mb-4">
            Tu menú digital,<br />
            <span className="text-emerald-500 text-3xl">siempre actualizado.</span>
          </h2>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 md:p-12 lg:p-16">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden flex justify-center mb-8">
            <Image src="/logo.svg" alt="Meniva Logo" width={80} height={80} />
          </div>

          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-3xl font-bold text-zinc-900 tracking-tight">Bienvenido</h2>
            <p className="text-zinc-500 mt-2">Ingresa tus credenciales para gestionar tu menú.</p>
          </div>
