    ...
    >
      ...
      {restaurant.whatsapp_number && (
        <a
          ...
          className="fixed bottom-6 left-4 right-4 md:left-auto md:right-6 md:w-auto z-50 flex items-center justify-center gap-2 px-6 py-3.5 rounded-full shadow-lg text-white font-semibold text-sm transition-transform hover:scale-105"
        ...
        >
          ...
          {restaurant.whatsapp_button_type?.toLowerCase().includes('reservar') ? 'Reservar Mesa' :
           restaurant.whatsapp_button_type?.toLowerCase().includes('consultar') ? 'Consultar' :
           'Hacer Pedido'}
        </a>
      )}
    </div>
